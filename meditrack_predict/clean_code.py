...
# Heading
w2 = Label(root, justify=LEFT, text=" Meditrack Disease Predictor", fg="white", bg="blue")
w2.config(font=("Elephant", 30))
w2.grid(row=1, column=0, columnspan=2, padx=100)
w2 = Label(root, justify=LEFT, text="By FRESHMANS", fg="white", bg="blue")
...
ranfLb = Label(root, text="Disease ", fg="white", bg="red")
